...
- `internal/doc/SKILL.md` (`read`) — Get document details
- `internal/doc/SKILL.md` (`update`) — Update document metadata
- `internal/doc/SKILL.md` (`delete`) — Remove a document record
- `internal/doc/SKILL.md` (`list`) — List documents (filter by project or type)
- `internal/doc/SKILL.md` (`search`) — Search documents by title or type
