...
- `agent:read` — Get agent details
- `agent:update` — Update agent name, role, or profile
- `agent:delete` — Remove an agent
- `agent:list` — List all agents (optionally filter by role)
- `agent:search` — Filter agents by name, role, or keyword
