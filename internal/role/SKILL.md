...
2. Run: `python3 atelier/scripts/roles.py create "<name>" "<description>"`
3. Confirm: "Role created: [name] (id: [id])"

### role:read
1. Ask: "Role ID?"
2. Run: `python3 atelier/scripts/roles.py get <id>`
3. Display all fields.

### role:update
1. Ask: "Role ID?" and "What to update (name / description)?"
2. Run: `python3 atelier/scripts/roles.py update <id> [--name "<name>"] [--description "<description>"]`
3. Confirm: "Role updated."

### role:delete
1. Ask: "Role ID? This cannot be undone."
2. Run: `python3 atelier/scripts/roles.py delete <id>`
3. Confirm: "Role deleted."

### role:list
1. Run: `python3 atelier/scripts/roles.py list`
2. Display results as a table: id | name | description

### role:search
1. Ask: "Search query?"
2. Run: `python3 atelier/scripts/roles.py search "<query>"`
