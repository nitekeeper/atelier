...
def test_upsert_session_updates_when_existing(mock_core):
    ...
    mock_core["query"].return_value = [{"id": 7, "project_id": 1,
                                         "agent_id": "atelier-pm-1",
                                         "status": "in-progress"}]
    mock_core["update"].return_value = {"id": 7, "project_id": 1,
                                         "agent_id": "atelier-pm-1",
